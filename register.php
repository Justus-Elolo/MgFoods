...
<head>
	<title>Mg Foods Restaurant - Create Account</title>
	<meta charset="UTF-8">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 form-row">
				...
				<div class="login100-more" style="background-image: url('img/logo/mgfoodhavenlogo.jpg');">
					<div id="header">
						<div id="logo" class="pull-left">
							<h1><a href="index#intro" class="scrollto">Mg Foods</a></h1>
