  ...
  <footer id="footer">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-md-6 footer-contact">
            ...
            <p>
              ...
              <strong>Phone:</strong>  0792453373<br>
              <strong>Email:</strong> restaurant@mgfoods.com<br>
            </p>
    ...
    <div class="container">
      <div class="copyright">
        &copy; Copyright <strong>Mg Foods Restaurant</strong>. All Rights Reserved
      </div>
      <div class="credits">
